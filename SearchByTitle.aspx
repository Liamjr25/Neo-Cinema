<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SearchByTitle.aspx.cs" Inherits="NeoCinemas.SearchByTitle" %>
...
.container1 > .btn:hover::after {
  ...
  transition-delay: 0.25s;
    ...
    <tr>
        <td style="color: #FFFFFF"><h1>Welcome To Search By Title</h1></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>
            <asp:Label ID="lblByTitle" runat="server" Text="Search By Title:" ForeColor="White"></asp:Label>
            <asp:TextBox ID="txtByTitle" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtByTitle" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    ...
    <tr>
        <td>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Id], [Title], [Genre], [Description], [Price], [MovieImage], [Year], [Length], [Country], [Language], [ProductionCompany], [Budget], [Cast], [AgeRestriction], [Music], [Director], [MovieCode], [Location] FROM [Movies] WHERE ([Title] = @Title)">
                <SelectParameters>
                    <asp:ControlParameter ControlID="txtByTitle" Name="Title" PropertyName="Text" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </td>
        <td>&nbsp;</td>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="AddMovieDetails.aspx.cs" Inherits="NeoCinemas.AddMovieDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        <table style="width:100%;">
            ...
            <tr>
                <td class="auto-style3"><h1>Welcome To Add Movie Details.</h1></td>
                <td>&nbsp;</td>
            </tr>
            <tr>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="txtTitle" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtGenre" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td>
        <asp:Label ID="lblDescription" runat="server" Text="Description"></asp:Label>
        <asp:TextBox ID="txtDescription" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="txtDescription" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtPrice" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtLength" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td>
    <asp:Label ID="lblYear" runat="server" Text="Year"></asp:Label>
    <asp:TextBox ID="txtYear" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtYear" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtCountry" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td>
        <asp:Label ID="lblLanguage" runat="server" Text="Language"></asp:Label>
        <asp:TextBox ID="txtLanguage" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txtLanguage" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtProductionCompany" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td class="auto-style2">
        <asp:Label ID="lblBudget" runat="server" Text="Budget"></asp:Label>
        <asp:TextBox ID="txtBudget" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="txtBudget" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtCast" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ControlToValidate="txtAgeRestriction" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtMusic" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td>
        <asp:Label ID="lblDirector" runat="server" Text="Director"></asp:Label>
        <asp:TextBox ID="txtDirector" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="txtDirector" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td>
        <asp:Label ID="lblMovieCode" runat="server" Text="MovieCode"></asp:Label>
        <asp:TextBox ID="txtnewMovieCode" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtnewMovieCode" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td>
        <asp:Label ID="lblLocation" runat="server" Text="Location"></asp:Label>
        <asp:TextBox ID="txtLocation" runat="server"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="txtLocation" ErrorMessage="Please Enter!*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td><div class="container">
        <div class="btn"><a href="#"><asp:Button ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="Add" BackColor="Transparent" /></a></div></div>
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM [Movies] WHERE [Id] = @Id" InsertCommand="INSERT INTO Movies(Id, Title, Genre, Description, Price, MovieImage, Length, Year, Country, Language, ProductionCompany, Budget, Cast, AgeRestriction, Music, Director, MovieCode, Location) VALUES (@Id, @Title, @Genre, @Description, @Price, @MovieImage, @Length, @Year, @Country, @Language, @ProductionCompany, @Budget, @Cast, @AgeRestriction, @Music, @Director, @MovieCode, @Location)" SelectCommand="SELECT [Id], [Title], [Genre], [Description], [Price], [MovieImage], [Length], [Year], [Country], [Language], [ProductionCompany], [Budget], [Cast], [AgeRestriction], [Music], [Director], [MovieCode], [Location] FROM [Movies]" UpdateCommand="UPDATE [Movies] SET [Title] = @Title, [Genre] = @Genre, [Description] = @Description, [Price] = @Price, [MovieImage] = @MovieImage, [Length] = @Length, [Year] = @Year, [Country] = @Country, [Language] = @Language, [ProductionCompany] = @ProductionCompany, [Budget] = @Budget, [Cast] = @Cast, [AgeRestriction] = @AgeRestriction, [Music] = @Music, [Director] = @Director, [MovieCode] = @MovieCode, [Location] = @Location WHERE [Id] = @Id">
                        ...
                        <InsertParameters>
                            ...
                            <asp:controlParameter ControlID="txtnewMovieCode" Name="MovieCode" Type="String" />

<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="SearchMovieByID1.aspx.cs" Inherits="NeoCinemas.SearchMovieByID1" %>
...
.container1 > .btn:hover::after {
  ...
  transition-delay: 0.25s;
    ...
    <table style="width: 687%;">
        ...
        <tr>
            <td><h1>Welcome To Search Movie By ID page:</h1></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [Id], [Title], [Genre], [Description], [Price], [MovieImage], [Length], [Year], [Country], [Language], [ProductionCompany], [Budget], [Cast], [AgeRestriction], [Music], [Director], [MovieCode], [Location] FROM [Movies] WHERE ([Id] = @Id)">
                    <SelectParameters>

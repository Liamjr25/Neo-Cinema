<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="DeleteAdmin.aspx.cs" Inherits="NeoCinemas.DeleteAdmin" %>
...
.container > .btn:nth-child(1)::after {
  ...
  box-shadow: 0 0 5px #2bd2ff, 0 0 15px #2bd2ff, 0 0 30px #2bd2ff,
    ...
    <table style="width:100%;">
        <tr>
            <td><h1 class="auto-style3">Welcome To Delete Admin</h1></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>
                <asp:Label ID="lblDeleteAdmin" runat="server" Text="Delete Admin"></asp:Label>

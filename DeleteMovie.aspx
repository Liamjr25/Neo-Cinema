<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="DeleteMovie.aspx.cs" Inherits="NeoCinemas.DeleteMovie" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <tr>
        <td><h1 class="auto-style3">Welcome To Delete Movie.</h1></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>Enter Movie Name:<asp:TextBox ID="txtMovieName" runat="server"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please Enter!" ControlToValidate="txtMovieName" ForeColor="Red"></asp:RequiredFieldValidator>
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>
            <asp:Label ID="lblMessageOne" runat="server" Text="Are You Sure You Want To Delete?"></asp:Label>
            <asp:Label ID="lblMessage2" runat="server" Text="Successful :)"></asp:Label>
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>
            <div class="container">
        <div class="btn"><a href="#"><asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" Text="Delete" style="height: 26px" BackColor="Transparent" /></a></div></div>
